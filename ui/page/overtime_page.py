...
from ui.widget.worker import Worker, QThread, Signal
from ui.widget.loading_dialog import LoadingDialog
...
from view_model.overtime_view_model import OvertimeViewModel
...
class OvertimePage(QWidget):
    def __init__(
        ...
        self.drop_area_1 = DropArea("Drop Overtime Excel File Here")
    ...
    def on_extract(self):
        ...
        if not file:
            QMessageBox.warning(self, "Warning", "Please drop an Overtime Excel file.")
            return
