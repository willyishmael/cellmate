...
from view_model.overtime_optdrv_view_model import OvertimeOptDrvViewModel
...
class OvertimeOptDrvPage(QWidget):
    def __init__(
        ...
        overtime_vm: Optional[OvertimeOptDrvViewModel] = None
    ):
        super().__init__()
        self.template_vm = template_vm or TemplateViewModel()
        self.overtime_vm = overtime_vm or OvertimeOptDrvViewModel()
        self.current_template_index = None
        self.template_type = "overtime_optdrv"
        self.overtime_template = []
