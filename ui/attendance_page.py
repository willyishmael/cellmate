...
class AttendancePage(QWidget):
    def __init__(self):
        ...
        form_layout.addRow("Sheet Name:", self.create_field("Enter sheet name (e.g., Sheet1)"))
        form_layout.addRow("Employee ID Column:", self.create_field("Enter column (e.g., 5, 6, 7)"))
        form_layout.addRow("Employee Name Column:", self.create_field("Enter column (e.g., 5, 6, 7)"))
        form_layout.addRow("Manpower Code Column:", self.create_field("Enter column (e.g., 5, 6, 7)"))
        form_layout.addRow("Data Start Row:", self.create_field("Enter row (e.g., 2, 3, 4)"))
        form_layout.addRow("Date Header Row:", self.create_field("Enter row (e.g., 1, 2)"))
        form_layout.addRow("Row Counter Column:", self.create_field("Enter column (e.g., 1, 2, 3)"))
        ...
        # Add text edit for employee IDs
        self.employee_ids_text_edit = QTextEdit()
        self.employee_ids_text_edit.setPlaceholderText("Enter Employee IDs separated by ',' (e.g., OBI-212365, OBI-7565324)")
        self.employee_ids_text_edit.setFixedHeight(60)  # Set height to 60
        form_layout.addRow("Employee IDs:", self.employee_ids_text_edit)
