...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.stacked.addWidget(self.overtime_optdrv_page)    # index 2
        self.stacked.addWidget(self.templates_page)   # index 3
        self.stacked.addWidget(self.app_info_page)    # index 4
